...
package com.liferay.projects.dashboards.business.unit.service.persistence.impl;
...
import com.liferay.projects.dashboards.business.unit.model.impl.ProjectBUImpl;
import com.liferay.projects.dashboards.business.unit.model.impl.ProjectBUModelImpl;
 ...
 * @see com.liferay.projects.dashboards.business.unit.service.persistence.ProjectBUUtil
 * @generated
 */
@ProviderType
public class ProjectBUPersistenceImpl extends BasePersistenceImpl<ProjectBU>
	 ...
	 */
	@Override
	public ProjectBU[] findByUuid_PrevAndNext(ProjectBUPK projectBUPK,
		String uuid, OrderByComparator<ProjectBU> orderByComparator)
		throws NoSuchProjectBUException {
		ProjectBU projectBU = findByPrimaryKey(projectBUPK);
	 ...
	 */
	@Override
	public ProjectBU[] findByUuid_C_PrevAndNext(ProjectBUPK projectBUPK,
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_TYPE = new FinderPath(ProjectBUModelImpl.ENTITY_CACHE_ENABLED,
			ProjectBUModelImpl.FINDER_CACHE_ENABLED, ProjectBUImpl.class,
	 ...
	 */
	@Override
	public ProjectBU findByType(String type) throws NoSuchProjectBUException {
		ProjectBU projectBU = fetchByType(type);
	 ...
	 */
	@Override
	public ProjectBU fetchByType(String type) {
	 ...
	 */
	@Override
	public ProjectBU fetchByType(String type, boolean retrieveFromCache) {
		...
		if (result instanceof ProjectBU) {
			ProjectBU projectBU = (ProjectBU)result;
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							_log.warn(
								"ProjectBUPersistenceImpl.fetchByType(String, boolean) with parameters (" +
								StringUtil.merge(finderArgs) +
								") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
						}
					}

					ProjectBU projectBU = list.get(0);

					result = projectBU;

					cacheResult(projectBU);

					if ((projectBU.getType() == null) ||
							!projectBU.getType().equals(type)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_TYPE,
							finderArgs, projectBU);
					}
				}
			}
			catch (Exception e) {
	 ...
	 */
	@Override
	public ProjectBU removeByType(String type) throws NoSuchProjectBUException {
		ProjectBU projectBU = findByType(type);
	...
	public void cacheResult(ProjectBU projectBU) {
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_TYPE,
			new Object[] { projectBU.getType() }, projectBU);
	...
	public void clearCache(ProjectBU projectBU) {
		...
		clearUniqueFindersCache((ProjectBUModelImpl)projectBU, true);
	}
	...
	protected void cacheUniqueFindersCache(
		ProjectBUModelImpl projectBUModelImpl) {
		Object[] args = new Object[] { projectBUModelImpl.getType() };

		finderCache.putResult(FINDER_PATH_COUNT_BY_TYPE, args, Long.valueOf(1),
			false);
		finderCache.putResult(FINDER_PATH_FETCH_BY_TYPE, args,
			projectBUModelImpl, false);
	}

	protected void clearUniqueFindersCache(
		ProjectBUModelImpl projectBUModelImpl, boolean clearCurrent) {
		if (clearCurrent) {
			Object[] args = new Object[] { projectBUModelImpl.getType() };
		...
		if ((projectBUModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] { projectBUModelImpl.getOriginalType() };
	 ...
	 */
	@Override
	public ProjectBU create(ProjectBUPK projectBUPK) {
		ProjectBU projectBU = new ProjectBUImpl();

		projectBU.setNew(true);
		projectBU.setPrimaryKey(projectBUPK);
	 ...
	 */
	@Override
	public ProjectBU remove(ProjectBUPK projectBUPK)
		throws NoSuchProjectBUException {
		return remove((Serializable)projectBUPK);
	}
	...
	public ProjectBU updateImpl(ProjectBU projectBU) {
		...
		clearUniqueFindersCache(projectBUModelImpl, false);
		cacheUniqueFindersCache(projectBUModelImpl);
	 ...
	 */
	@Override
	public ProjectBU findByPrimaryKey(ProjectBUPK projectBUPK)
		throws NoSuchProjectBUException {
		return findByPrimaryKey((Serializable)projectBUPK);
	}
	 ...
	 */
	@Override
	public ProjectBU fetchByPrimaryKey(ProjectBUPK projectBUPK) {
		return fetchByPrimaryKey((Serializable)projectBUPK);
	}
