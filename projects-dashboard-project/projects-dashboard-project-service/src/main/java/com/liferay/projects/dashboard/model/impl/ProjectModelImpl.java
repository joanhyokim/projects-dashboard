...
import com.liferay.projects.dashboard.model.ProjectModel;
import com.liferay.projects.dashboard.model.ProjectSoap;
...
public class ProjectModelImpl extends BaseModelImpl<Project>
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.projects.dashboard.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.projects.dashboard.model.Project"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.projects.dashboard.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.projects.dashboard.model.Project"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.projects.dashboard.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.liferay.projects.dashboard.model.Project"),
			true);
	...
	public static Project toModel(ProjectSoap soapModel) {
		...
		model.setHealth(soapModel.getHealth());
		model.setExpectedStartDate(soapModel.getExpectedStartDate());
		model.setExpectedEndDate(soapModel.getExpectedEndDate());
		model.setActualStartDate(soapModel.getActualStartDate());
		model.setActualEndDate(soapModel.getActualEndDate());
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.projects.dashboard.service.util.ServiceProps.get(
				"lock.expiration.time.com.liferay.projects.dashboard.model.Project"));
